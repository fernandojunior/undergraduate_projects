...
import model.CursoManager;
import model.PessoaManager;
import model.TurmaManager;
 ...
 */
@Deprecated
public class EscolaManager_Linhadecomando {

	/**
	 * Gerenciador de professores
	 */
	private static PessoaManager professores = new PessoaManager(
			Professor.class.toString());
	/**
	 * Gerenciador de alunos
	 */
	private static PessoaManager alunos = new PessoaManager(
			Aluno.class.toString());
	/**
	 * Gerenciador de cursos
	 */
	private static CursoManager cursos = new CursoManager();
	/**
	 * Gerenciador de turmas
	 */
	private static TurmaManager turmas = new TurmaManager();
	 ...
	 *             parametro
	 */
	public static boolean adicionar(IEntidade entidade) throws NamingException,
	 ...
	 *             Se nao existe a entidade
	 */
	public static boolean adicionar(Turma turma, Curso curso)
	 ...
	 *             Se nao existe a entidade
	 */
	public static boolean adicionar(Aluno aluno, Turma turma)
			throws GetException, NamingException {
	 ...
	 *             Se nao existe a entidade
	 */
	public static ArrayList<? extends Object> get(String tipoDeEntidade,
	 ...
	 *             Se nao existe a entidade
	 */
	public static boolean atualizar(IEntidade entidade, String tipoDoAtributo,
	 ...
	 *             Se nao existe a entidade
	 */
	public static boolean remover(Aluno aluno, Turma turma)
			throws GetException, NamingException {
	 ...
	 */
	public static boolean remover(IEntidade entidade) throws NamingException {
