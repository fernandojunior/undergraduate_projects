...
public class ServletControl {
	 ...
	 */
	private SistemaAcademicoModel model = new SistemaAcademicoModel();
	 ...
	 * 
	 */
	private List<Integer> vetorDeSequencia = new ArrayList<Integer>();

	/**
	 * Vetor de parametros necessarios para executar um determinado metodo do
	 * sistema
	 */
	private List<String> vetorDeParametros = new ArrayList<String>();
	 ...
	 *            Sequencia
	 */
	private void mapearMenu(String menu) {
	 ...
	 */
	private void mapearParametros(ArrayList<String> parametrosDeRequisicao) {
	...
	private void menuPessoa(String tipo) {
	...
	private ArrayList<String> exemploMatricularPessoa() {
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploExcluirPessoa() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploEditarPessoa() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploConsultarPessoa() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploCriarCurso() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploExcluirCurso() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploEditarCurso() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploConsultarCurso() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploCriarTurma() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploExcluirTurma() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploEditarTurma() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploConsultarTurma() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	@SuppressWarnings("unused")
	private ArrayList<String> exemploAdicionarAlunoNaTurma() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
	...
	//@SuppressWarnings("unused")
	private ArrayList<String> exemploExcluirAlunoDaTurma() {
		ArrayList<String> simulacaoGetRequestParams = new ArrayList<String>();
